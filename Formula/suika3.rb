class Suika3 < Formula
  ...
  def install
    system "cmake", ".", "-DCMAKE_BUILD_TYPE=Release", "-DCMAKE_OSX_ARCHITECTURES=`uname -m`", "-DCMAKE_OSX_DEPLOYMENT_TARGET=10.11", "-DSUIKA_TARGET_MACOS_CLI=ON", "-DSUIKA_ENABLE_INSTALL=ON", "-DSUIKA_ENABLE_JIT=ON", "-DSUIKA_ENABLE_I18N=ON", "-DSUIKA_ENABLE_PACK=ON", "-DSUIKA_ENABLE_BYTECOMP=ON", "-DSUIKA_ENABLE_AOTCOMP=ON" "-DSUIKA_ENABLE_DIST=ON", *std_cmake_args
    system "cmake", "--build", "."
